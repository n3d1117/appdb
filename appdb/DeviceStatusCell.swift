...
class DeviceStatusCell: UITableViewCell {
    ...
    var status_left, type_left, title_left, bundle_left, purpose_left, statusShort_left, statusText_left: UILabel!
    var status, type, title, bundle, purpose, statusShort, statusText: UILabel!
                ...
                constrain(title_left, title) { til, ti in
                    ...
                    constrain(bundle_left, bundle) { bl, b in
                        ...
                        constrain(purpose_left, purpose) { pl, p in
                            ...
                            p.right == p.superview!.right - Global.size.margin.value
                            p.top == pl.top
                            
                            constrain(statusShort_left, statusShort) { ssl, ss in
                                ssl.top == p.bottom + margin ~ Global.notMaxPriority
                                ssl.left == pl.left
                                ssl.right == pl.right
